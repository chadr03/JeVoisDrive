...
public class Robot extends TimedRobot {
  ...
  public static JevoisSubsystem jSubsystem = new JevoisSubsystem();
 ...
 // private SerialPort jevois;
  ...
  public void robotInit() {
    ...
    SmartDashboard.putNumber("Distance Setpoint", 20.0);
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putBoolean("Target Found",jSubsystem.isTargetVisable());
    SmartDashboard.putNumber("Target X", jSubsystem.getTgtX());
    SmartDashboard.putNumber("Target Y", jSubsystem.getTgtY());
    //if(jSubsystem.jevois.getBytesReceived() > 0){
    System.out.print(jSubsystem.getJevoisPacket());
    //}
  }
